...
// Individual test: SUB reg -- A <- A - reg
module test_sub;
    reg clk = 0;
    reg reset = 0;
    reg program_mode = 0;
    ...
    initial begin
        ...
        prog[0] = 8'h08; prog[1] = 8'd10; // LD A,#10   A=9
        prog[2] = 8'h09; prog[3] = 8'd11; // LD B,#11   B=4
        prog[4] = 8'h21;                  // SUB B      A=9-4=5
        prog[5] = 8'h40;                  // OUT A
        prog[6] = 8'hFF;                  // HLT
        prog[10] = 8'd9;
        prog[11] = 8'd4;
        ...
        if (external_output == 8'd5)
            $display("PASS SUB: external_output = %0d (expected 5)", external_output);
        else
            $display("FAIL SUB: external_output = %0d (expected 5)", external_output);
