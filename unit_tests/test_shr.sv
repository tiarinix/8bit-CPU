...
module test_shr;
    ...
    initial begin
        ...
        prog[0] = 8'h08; prog[1] = 8'd10; // LD A,#10   A=0xF0(240)
        prog[2] = 8'h5A;                  // SHR        A=0x78(120)
        prog[3] = 8'h40;                  // OUT A
        prog[4] = 8'hFF;                  // HLT
        prog[10] = 8'hF0;
        ...
        if (external_output == 8'd120)
            $display("PASS SHR: external_output = %0d (expected 120)", external_output);
        else
            $display("FAIL SHR: external_output = %0d (expected 120)", external_output);
