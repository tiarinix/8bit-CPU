...
// Individual test: ST reg,addr -- mem[addr] <- reg (roundtrip: write with A, read back with B)
module test_st;
    reg clk = 0;
    reg reset = 0;
    reg program_mode = 0;
    ...
    initial begin
        ...
        prog[0] = 8'h08; prog[1] = 8'd10; // LD A,#10   A=7
        prog[2] = 8'h10; prog[3] = 8'd11; // ST A,#11   mem[11]<-A
        prog[4] = 8'h09; prog[5] = 8'd11; // LD B,#11   B<-mem[11]
        prog[6] = 8'h41;                  // OUT B
        prog[7] = 8'hFF;                  // HLT
        prog[10] = 8'd7;                  // data: 7
        prog[11] = 8'd0;                  // placeholder, overwritten by ST
