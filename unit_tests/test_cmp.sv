...
module test_cmp;
    ...
    initial begin
        ...
        prog[0] = 8'h08; prog[1] = 8'd20;  // LD A,#20   A=7
        prog[2] = 8'h09; prog[3] = 8'd21;  // LD B,#21   B=7
        prog[4] = 8'h61;                   // CMP B      flags: zero=1, A stays=7
        prog[5] = 8'h51; prog[6] = 8'd11;  // JZ #11     should jump
        prog[7] = 8'h08; prog[8] = 8'd22;  // TRAP: LD A,#22 (bad=99)
        prog[9] = 8'h40;                   // OUT A
        prog[10] = 8'hFF;                  // HLT
        prog[11] = 8'h40;                  // CORRECT: OUT A (A stays=7, CMP didn't touch it)
        prog[12] = 8'hFF;                  // HLT
        prog[20] = 8'd7;
        prog[21] = 8'd7;
        prog[22] = 8'd99;
