...
// Individual test: ADD reg -- A <- A + reg
module test_add;
    reg clk = 0;
    reg reset = 0;
    reg program_mode = 0;
    ...
    initial begin
        ...
        prog[0] = 8'h08; prog[1] = 8'd10; // LD A,#10   A=5
        prog[2] = 8'h09; prog[3] = 8'd11; // LD B,#11   B=3
        prog[4] = 8'h19;                  // ADD B      A=5+3=8
        prog[5] = 8'h40;                  // OUT A
        prog[6] = 8'hFF;                  // HLT
        prog[10] = 8'd5;
        prog[11] = 8'd3;
        ...
        if (external_output == 8'd8)
            $display("PASS ADD: external_output = %0d (expected 8)", external_output);
        else
            $display("FAIL ADD: external_output = %0d (expected 8)", external_output);
